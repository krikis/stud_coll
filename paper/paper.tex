...
Apart from resolving context conflicts it is also possible to represent inconsistencies into the context model itself~\cite{ko:2009:IOFO}. In this paper we present a use case in which we explore the possibilities of incorporating inconsitencies into context models using fuzzy ontologies.
} % end of abstract
